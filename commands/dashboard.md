...
server log or block waiting on it. The dashboard keeps running on its own; its six views —
**Console / Plan / Timeline / Graph / Insights / Doctor** — update live as the plan evolves.
