...
2. **Exactly two integers** `N M` (e.g. `5 8` — two whitespace-separated integers and nothing
   else): invoke planwright with `cycle <N> depth <M> explore`. Same advisor workflow, custom
   round count and depth.
