...
for case_file in statics-scaffold skill-contract skill-guards build-graph unit-engine lint-plan lifecycle doctor status state dashboard derive check-links golden-plan integration-scale commands install-aliases; do
  # shellcheck source=/dev/null
