...
for case_file in statics-scaffold skill-contract skill-guards build-graph unit-engine lint-plan lifecycle doctor golden-plan integration-scale commands; do
  # shellcheck source=/dev/null
